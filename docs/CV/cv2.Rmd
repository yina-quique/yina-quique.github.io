...
`r fontawesome::fa("globe")` [yinaquique.com](https://yina-quique.github.io/) `r knitr::asis_output("\U00B7")`
...
`r fontawesome::fa("github")` [Github](https://github.com/yina-quique) `r knitr::asis_output("\U00B7")` 
